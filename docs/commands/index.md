...
All commands are subcommands of `tooling okf` and use the explicit `docs` bundle
...
- [tree](tree.md) — summarize directories and concepts.
- [list](list.md) — inventory concepts with filters and windows.
